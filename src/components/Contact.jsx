    ...
    <section id="contato" className="py-20 bg-gray-50 bg-dot-pattern">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 bg-white rounded-2xl shadow-xl overflow-hidden">
          <div
            className="bg-led-blue text-white p-10 flex flex-col justify-between"
            data-aos="fade-right"
          >
            <div>
            ...
            <div className="mt-10 rounded-lg overflow-hidden h-64 shadow-lg border-2 border-blue-400">
              <iframe
                ...
                height="100%"
                style={{ border: 0 }}
                title="Mapa de localização da LED Informática em Goiânia"
                allowFullScreen=""
                loading="lazy"
            ...
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full border-gray-300 border rounded-lg px-4 py-2 focus:ring-2 focus:ring-led-light focus:border-led-light outline-none transition"
